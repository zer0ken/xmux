...
async fn scan_or_dispatch_host_detects_from_hosts_without_env() {
    ...
    let gate = std::sync::Arc::new(tokio::sync::Semaphore::new(crate::provision::config::SCAN_CONCURRENCY_MAX));
...
fn test_rt(env: Env) -> Runtime {
    ...
    Runtime {
        ...
        switcher,
        state,
        scan_pool: std::sync::Arc::new(tokio::sync::Semaphore::new(crate::provision::config::SCAN_CONCURRENCY_MAX)),
        attach_seq: 0,
